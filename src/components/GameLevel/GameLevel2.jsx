...
import '/global.css';
import bgImage from '/assets/13_liska.png'; // uprav dle projektu
        ...
        <footer className="footer">
          <div className="story-wrapper">
            <p>
              ...
              ipsum dolor sit amet consectetur adipisicing elit. Est sapiente
              quasi ratione alias cupiditate! Molestiae dolores minima ratione
              beatae dolorem.
            </p>
